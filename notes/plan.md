...
25 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
distance_hereditary); the other 48 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
