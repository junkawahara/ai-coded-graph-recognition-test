...
31 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
kregular, snark); the other 42 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
