...
19 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
circle, eulerian); the other 54 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
