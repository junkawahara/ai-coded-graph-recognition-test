...
20 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
circle, eulerian, biconnected); the other 53 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
