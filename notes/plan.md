...
43 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
polyhedral, cubic_planar, tournament, digraph); the other 30 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
