...
51 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
partial_ktree, degenerate); the other 26 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
