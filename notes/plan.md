...
40 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
polyhedral); the other 33 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
