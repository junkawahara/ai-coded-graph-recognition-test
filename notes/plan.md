...
18 classes have one (tree, forest, caterpillar, unicyclic, halin, fullerene,
...
circle); the other 55 classes with a labeled enumerator do not. Convention: `notes/enum_alg.md`
