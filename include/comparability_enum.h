...
struct ComparabilityEnumerationResult {
    std::vector<EnumeratedGraph> graphs; /**< 列挙された比較可能性グラフの配列 */
};
...
/**
 * @brief 比較可能性グラフ逆探索の DFS
 *
 * 頂点 alive_count+1 を追加し、{1,...,alive_count} の部分集合を
 * 近傍として試す。比較可能性でない子を枝刈りする。
 */
...
/**
 * @brief 頂点集合 {1, ..., n} 上のラベル付き比較可能性グラフを全列挙する
 * @param n 頂点数
