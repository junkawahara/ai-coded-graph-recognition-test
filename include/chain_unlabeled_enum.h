 ...
 */
enum class ChainUnlabeledEnumAlgorithm {
 ...
 */
struct ChainUnlabeledEnumeratedGraph {
 ...
 */
struct ChainUnlabeledEnumerationResult {
    std::vector<ChainUnlabeledEnumeratedGraph> graphs;     /**< array of enumerated chain graphs */
};
...
inline void enumerate_staircases(
    ...
    std::vector<ChainUnlabeledEnumeratedGraph>& out,
    int n)
{
    if (pos == p) {
        ...
        ChainUnlabeledEnumeratedGraph g;
        g.n = n;
        for (int i = 0; i < p; ++i) {
 ...
 * @return ChainUnlabeledEnumerationResult
 *
 ...
 */
inline ChainUnlabeledEnumerationResult enumerate_chain_unlabeled_graphs(int n,
    ChainUnlabeledEnumAlgorithm algo = ChainUnlabeledEnumAlgorithm::STAIRCASE) {
    (void)algo;
    ChainUnlabeledEnumerationResult result;
