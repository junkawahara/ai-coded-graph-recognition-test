...
/**
 * @file self_complementary_labeled_enum.h
 ...
 */
enum class SelfComplementaryLabeledEnumAlgorithm {
 ...
 */
struct SelfComplementaryLabeledEnumerationResult {
 ...
 */
inline SelfComplementaryLabeledEnumerationResult
enumerate_self_complementary_labeled_graphs(
    int n,
    SelfComplementaryLabeledEnumAlgorithm algo =
        SelfComplementaryLabeledEnumAlgorithm::COMPLEMENTING_PERMUTATION) {
    (void)algo;

    SelfComplementaryLabeledEnumerationResult result;
