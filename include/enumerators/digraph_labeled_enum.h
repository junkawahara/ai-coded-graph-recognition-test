 ...
 */
struct DigraphLabeledEnumeratedGraph {
 ...
 */
struct DigraphLabeledEnumerationResult {
    std::vector<DigraphLabeledEnumeratedGraph> graphs;   /**< Array of enumerated digraphs */
};

namespace detail_digraph_enum {

/** @brief Internal state for constructive enumeration */
struct DigraphLabeledEnumState {
    int n;                                         /**< Number of vertices */
 ...
 */
inline DigraphLabeledEnumState digraph_build_state(int n) {
    DigraphLabeledEnumState state;
    state.n = n;
    for (int i = 1; i <= n; ++i) {
        for (int j = i + 1; j <= n; ++j) {
 ...
 */
inline void digraph_labeled_enum_dfs(DigraphLabeledEnumState& state, int pair_idx,
                             std::vector<DigraphLabeledEnumeratedGraph>* out) {
    if (pair_idx == state.num_pairs) {
        DigraphLabeledEnumeratedGraph g;
        g.n = state.n;
    ...
    // Branch 0: no edge
    digraph_labeled_enum_dfs(state, pair_idx + 1, out);
 ...
 * @return DigraphLabeledEnumerationResult
 *
 ...
 */
inline DigraphLabeledEnumerationResult enumerate_digraphs(int n) {
    DigraphLabeledEnumerationResult result;
    ...
    detail_digraph_enum::DigraphLabeledEnumState state =
        detail_digraph_enum::digraph_build_state(n);
    detail_digraph_enum::digraph_labeled_enum_dfs(state, 0, &result.graphs);
    return result;
}
