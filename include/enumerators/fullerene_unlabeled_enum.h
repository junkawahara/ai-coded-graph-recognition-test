...
/**
 * @file fullerene_unlabeled_enum.h
...
struct FullereneUnlabeledEnumeratedGraph {
    int n;
    std::vector<std::pair<int, int> > edges;
};

struct FullereneUnlabeledEnumerationResult {
    std::vector<FullereneUnlabeledEnumeratedGraph> graphs;
};

enum class FullereneUnlabeledEnumAlgorithm {
    REVERSE_SEARCH
};
...
inline void triang_enum_choose(TriangEnumState& state,
                                ...
                                std::vector<FullereneUnlabeledEnumeratedGraph>* out);
...
inline void triang_enum_dfs(TriangEnumState& state,
    ...
    if (state.alive_count == v) {
        ...
        FullereneUnlabeledEnumeratedGraph graph;
        graph.n = fullerene_n;
 ...
 * @return FullereneUnlabeledEnumerationResult
 */
inline FullereneUnlabeledEnumerationResult
enumerate_fullerene_unlabeled_graphs(int n,
    FullereneUnlabeledEnumAlgorithm algo =
        FullereneUnlabeledEnumAlgorithm::REVERSE_SEARCH) {
    (void)algo;
    FullereneUnlabeledEnumerationResult result;
