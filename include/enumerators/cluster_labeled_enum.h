 ...
 */
struct ClusterLabeledEnumeratedGraph {
 ...
 */
struct ClusterLabeledEnumerationResult {
    std::vector<ClusterLabeledEnumeratedGraph> graphs;   /**< array of enumerated cluster graphs */
};
 ...
 * @return ClusterLabeledEnumeratedGraph
 *
 * Adds all vertex pairs within each block as edges (complete graph).
 */
inline ClusterLabeledEnumeratedGraph build_cluster_graph(
    int n,
    const std::vector<std::vector<int> >& blocks) {
    ClusterLabeledEnumeratedGraph g;
    g.n = n;
...
inline void set_partition_dfs(
    ...
    std::vector<ClusterLabeledEnumeratedGraph>& out) {
    if (vertex > n) {
 ...
 * @param n Number of vertices
 * @return ClusterLabeledEnumerationResult
 *
 * Constructs B(n) graphs via recursive set partition enumeration.
 */
inline ClusterLabeledEnumerationResult enumerate_cluster_labeled_graphs(int n) {
    ClusterLabeledEnumerationResult result;
