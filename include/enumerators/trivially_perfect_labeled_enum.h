...
/**
 * @file trivially_perfect_labeled_enum.h
 ...
 */
enum class TriviallyPerfectLabeledEnumAlgorithm {
 ...
 */
struct TriviallyPerfectLabeledEnumerationResult {
 ...
 * @return TriviallyPerfectLabeledEnumerationResult
 *
 ...
 */
inline TriviallyPerfectLabeledEnumerationResult
enumerate_trivially_perfect_labeled_graphs_uvd(int n,
    TriviallyPerfectLabeledEnumAlgorithm algo =
        TriviallyPerfectLabeledEnumAlgorithm::UVD_TREE) {
    (void)algo;
    TriviallyPerfectLabeledEnumerationResult result;
