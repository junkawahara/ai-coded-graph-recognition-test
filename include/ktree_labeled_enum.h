 ...
 */
struct KTreeLabeledEnumerationResult {
 ...
 */
inline bool ktree_is_simplicial_leq_k(const ChordalLabeledEnumState& state,
                                       int v, int k) {
 ...
 */
inline int ktree_canonical_removed_vertex(const ChordalLabeledEnumState& state,
                                           int k) {
    int best = 0;
 ...
 */
inline void enumerate_exact_k_cliques_dfs(const ChordalLabeledEnumState& state,
...
inline std::vector<std::vector<int>> enumerate_exact_k_cliques(
    const ChordalLabeledEnumState& state, int k) {
 ...
 */
inline void ktree_reverse_search_dfs(ChordalLabeledEnumState& state, int k,
 ...
 * @return KTreeLabeledEnumerationResult
 *
 * Returns empty result if n < k+1 (K_{k+1} is the smallest k-tree).
 * For k=0, returns one empty graph with 0 edges.
 */
inline KTreeLabeledEnumerationResult enumerate_ktree_labeled_graphs_reverse_search(int n,
                                                                     int k) {
    KTreeLabeledEnumerationResult result;
