...
/**
 * @file diamond_free_labeled_enum.h
 ...
 */
enum class DiamondFreeLabeledEnumAlgorithm {
 ...
 */
struct DiamondFreeLabeledEnumerationResult {
...
struct DiamondFreeLabeledEnumState {
    int total_n;
    int alive_count;  /**< Alive vertices are {1, ..., alive_count} */
    std::vector<std::vector<char>> adj;

    explicit DiamondFreeLabeledEnumState(int n)
 ...
 */
inline void diamond_free_labeled_enum_dfs(DiamondFreeLabeledEnumState& state,
    ...
    for (unsigned long long mask = 0; mask < limit; ++mask) {
        ...
        if (res.is_diamond_free) {
            diamond_free_labeled_enum_dfs(state, out);
        }
 ...
 * @return DiamondFreeLabeledEnumerationResult
 *
 ...
 */
inline DiamondFreeLabeledEnumerationResult
enumerate_diamond_free_labeled_graphs_reverse_search(int n,
    DiamondFreeLabeledEnumAlgorithm algo =
        DiamondFreeLabeledEnumAlgorithm::REVERSE_SEARCH) {
    (void)algo;
    DiamondFreeLabeledEnumerationResult result;
    if (n < 0) return result;
    detail::DiamondFreeLabeledEnumState root(n);
    detail::diamond_free_labeled_enum_dfs(root, &result.graphs);
    return result;
}
