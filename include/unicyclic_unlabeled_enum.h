...
/**
 * @file unicyclic_unlabeled_enum.h
 ...
 *
 * Rooted tree generation reuses compute_rooted_trees from tree_unlabeled_enum.h.
 *
 ...
 */
struct UnicyclicUnlabeledEnumeratedGraph {
 ...
 */
struct UnicyclicUnlabeledEnumerationResult {
    std::vector<UnicyclicUnlabeledEnumeratedGraph> graphs;
};
...
struct RootedTreeTable {
    ...
    /** Rooted tree cache (from tree_unlabeled_enum.h) */
 ...
 */
inline void unicyclic_unlabeled_enum_dfs(
    int pos, int remaining, int g,
    std::vector<int>& sizes,
    std::vector<int>& indices,
    std::vector<int>& id_seq,
    const RootedTreeTable& table,
    std::vector<UnicyclicUnlabeledEnumeratedGraph>& results,
    int n) {
    ...
    if (pos == g) {
        ...
        // Graph construction
        UnicyclicUnlabeledEnumeratedGraph graph;
        graph.n = n;
 ...
 * @return UnicyclicUnlabeledEnumerationResult
 *
 ...
 */
inline UnicyclicUnlabeledEnumerationResult enumerate_unicyclic_unlabeled_graphs(int n) {
    UnicyclicUnlabeledEnumerationResult result;
    ...
    for (int g = 3; g <= n; ++g) {
        ...
        detail::unicyclic_unlabeled_enum_dfs(
