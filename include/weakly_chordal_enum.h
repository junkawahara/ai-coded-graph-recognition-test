...
template <typename Callback>
inline void enumerate_weakly_chordal_graphs_kiyomi_cb(int n, Callback& cb) {
 ...
 */
template <typename Callback>
inline void enumerate_weakly_chordal_graphs_reverse_search_cb(
    int n,
    Callback&& cb,
    WeaklyChordalEnumAlgorithm algo =
        WeaklyChordalEnumAlgorithm::KIYOMI_EDGE_ADDITION) {
