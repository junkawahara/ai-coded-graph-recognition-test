...
/**
 * @file strongly_regular_labeled_enum.h
 ...
 *   2. For each parameter, construct via kregular_labeled_enum-style backtracking
 ...
 */
enum class StronglyRegularLabeledEnumAlgorithm {
 ...
 */
struct StronglyRegularLabeledEnumerationResult {
 ...
 * @return StronglyRegularLabeledEnumerationResult
 */
inline StronglyRegularLabeledEnumerationResult
enumerate_strongly_regular_labeled_graphs(int n,
    StronglyRegularLabeledEnumAlgorithm algo =
        StronglyRegularLabeledEnumAlgorithm::BACKTRACK) {
    (void)algo;
    StronglyRegularLabeledEnumerationResult result;
