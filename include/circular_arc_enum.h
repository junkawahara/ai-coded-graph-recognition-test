 ...
 * @brief 円弧グラフ (circular-arc graph) の列挙 (逆探索)
 *
 ...
 * すべての部分集合を列挙して circular-arc 判定でフィルタする。
 */
...
struct CircularArcEnumerationResult {
    std::vector<EnumeratedGraph> graphs; /**< 列挙された円弧グラフの配列 */
};
 ...
 * 近傍として試す。circular-arc でない子を枝刈りする。
 */
