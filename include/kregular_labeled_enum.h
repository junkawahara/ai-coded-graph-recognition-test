 ...
 */
enum class KRegularLabeledEnumAlgorithm {
 ...
 */
struct KRegularLabeledEnumerationResult {
...
struct KRegularLabeledEnumState {
    int total_n;
    int target_k;
    ...
    KRegularLabeledEnumState(int n, int k)
 ...
 */
inline void kregular_labeled_enum_choose(KRegularLabeledEnumState& state,
 ...
 */
inline void kregular_labeled_enum_dfs(KRegularLabeledEnumState& state,
                               std::vector<EnumeratedGraph>* out) {
    ...
    kregular_labeled_enum_choose(state, available, 0, 0,
...
inline void kregular_labeled_enum_choose(KRegularLabeledEnumState& state,
    ...
    if (chosen_count >= min_size) {
        ...
        if (feasible) {
            kregular_labeled_enum_dfs(state, out);
        }
    ...
    for (std::size_t i = start; i < available.size(); ++i) {
        ...
        kregular_labeled_enum_choose(state, available, i + 1, chosen_count + 1,
 ...
 * @return KRegularLabeledEnumerationResult
 */
inline KRegularLabeledEnumerationResult
enumerate_kregular_labeled_graphs_reverse_search(int n, int k,
    KRegularLabeledEnumAlgorithm algo =
        KRegularLabeledEnumAlgorithm::REVERSE_SEARCH) {
    (void)algo;
    KRegularLabeledEnumerationResult result;
    ...
    detail::KRegularLabeledEnumState root(n, k);
    detail::kregular_labeled_enum_dfs(root, &result.graphs);
    return result;
}
