...
_ENUM_TYPES = [
    ...
    "co_comparability_unlabeled",
    "co_interval_labeled",
    "co_interval_unlabeled",
    "cochain_unlabeled",
    "cograph_labeled",
    "cograph_unlabeled",
    "comparability_labeled",
    "comparability_unlabeled",
    ...
    "interval_unlabeled",
    "line_graph_labeled",
    "maximal_outer_planar_unlabeled",
    "maximal_planar_unlabeled",
    "outer_planar_labeled",
    "outer_planar_unlabeled",
    "perfect_labeled",
    "permutation_labeled",
...
_ENUM_ALGORITHMS = {
    ...
    "co_comparability_unlabeled": "complement of comparability graph enumeration",
    "co_interval_unlabeled": "complement of interval graph enumeration",
    ...
    "comparability_unlabeled": "McKay canonical augmentation (recognizer-pruned)",
    "cubic_planar_unlabeled": "McKay canonical augmentation (degree- and planarity-constrained)",
    "cubic_unlabeled": "McKay canonical augmentation (snarkhunter style degree constraint)",
    ...
    "interval_unlabeled": "McKay canonical augmentation (recognizer-pruned)",
    "maximal_outer_planar_unlabeled": "polygon triangulations modulo the dihedral group",
    "maximal_planar_unlabeled": "McKay canonical augmentation (planarity-pruned, edge-count window)",
    "outer_planar_unlabeled": "McKay canonical augmentation (recognizer-pruned)",
    ...
    "polyhedral_unlabeled": "McKay canonical augmentation (planarity-pruned, edge-count window, full 3-connectivity check at the last level)",
