...
using graph_recognition::KTreeLabeledEnumerationResult;
using graph_recognition::check_ktree;
using graph_recognition::enumerate_ktree_labeled_graphs_reverse_search;
...
const char* kDir = "ktree_labeled_enum";

class KTreeLabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(KTreeLabeledEnumTest, CountAndAllValid) {
    ...
    KTreeLabeledEnumerationResult res = enumerate_ktree_labeled_graphs_reverse_search(n, k);
