...
using graph_recognition::PolyhedralEnumerationResult;
using graph_recognition::check_polyhedral;
using graph_recognition::enumerate_polyhedral_graphs;
...
const char* kDir = "polyhedral_enum";

class PolyhedralEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(PolyhedralEnumTest, CountAndAllValid) {
    ...
    PolyhedralEnumerationResult res = enumerate_polyhedral_graphs(n);
