...
const char* kDir = "ptolemaic_enum";

class PtolemaicEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(PtolemaicEnumTest, CountAndAllValid) {
    ...
    PtolemaicEnumerationResult res = enumerate_ptolemaic_graphs_reverse_search(n);
