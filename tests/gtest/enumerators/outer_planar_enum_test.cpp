...
const char* kDir = "outer_planar_enum";

class OuterPlanarEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(OuterPlanarEnumTest, CountAndAllValid) {
    ...
    OuterPlanarEnumerationResult res = enumerate_outer_planar_graphs_reverse_search(n);
