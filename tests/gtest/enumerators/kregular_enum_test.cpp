...
using graph_recognition::KRegularEnumerationResult;
using graph_recognition::check_kregular;
using graph_recognition::enumerate_kregular_graphs_reverse_search;
...
const char* kDir = "kregular_enum";

class KRegularEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(KRegularEnumTest, CountAndAllValid) {
    ...
    KRegularEnumerationResult res = enumerate_kregular_graphs_reverse_search(n, k);
