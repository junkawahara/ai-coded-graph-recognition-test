...
using graph_recognition::EulerianEnumerationResult;
using graph_recognition::check_eulerian;
using graph_recognition::enumerate_eulerian_graphs;
...
const char* kDir = "eulerian_enum";

class EulerianEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(EulerianEnumTest, CountAndAllValid) {
    ...
    EulerianEnumerationResult res = enumerate_eulerian_graphs(n);
