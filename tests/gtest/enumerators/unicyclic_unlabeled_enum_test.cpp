...
using graph_recognition::UnicyclicUnlabeledEnumerationResult;
using graph_recognition::check_unicyclic;
using graph_recognition::enumerate_unicyclic_unlabeled_graphs;
...
const char* kDir = "unicyclic_unlabeled_enum";

class UnicyclicUnlabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(UnicyclicUnlabeledEnumTest, CountAndAllValid) {
    ...
    UnicyclicUnlabeledEnumerationResult res = enumerate_unicyclic_unlabeled_graphs(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, UnicyclicUnlabeledEnumTest,
