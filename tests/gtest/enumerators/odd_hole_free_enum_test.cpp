...
using graph_recognition::OddHoleFreeEnumerationResult;
using graph_recognition::check_odd_hole_free;
using graph_recognition::enumerate_odd_hole_free_graphs_reverse_search;
...
const char* kDir = "odd_hole_free_enum";

class OddHoleFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(OddHoleFreeEnumTest, CountAndAllValid) {
    ...
    OddHoleFreeEnumerationResult res = enumerate_odd_hole_free_graphs_reverse_search(n);
