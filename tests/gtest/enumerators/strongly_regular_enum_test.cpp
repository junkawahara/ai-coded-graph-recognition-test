...
using graph_recognition::StronglyRegularEnumerationResult;
using graph_recognition::check_strongly_regular;
using graph_recognition::enumerate_strongly_regular_graphs;
...
const char* kDir = "strongly_regular_enum";

class StronglyRegularEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(StronglyRegularEnumTest, CountAndAllValid) {
    ...
    StronglyRegularEnumerationResult res = enumerate_strongly_regular_graphs(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, StronglyRegularEnumTest,
