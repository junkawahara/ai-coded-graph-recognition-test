...
using graph_recognition::BipartitePermutationLabeledEnumerationResult;
...
const char* kDir = "bipartite_permutation_labeled_enum";

class BipartitePermutationLabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(BipartitePermutationLabeledEnumTest, CountAndAllValid) {
    ...
    BipartitePermutationLabeledEnumerationResult res = enumerate_bipartite_permutation_labeled_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, BipartitePermutationLabeledEnumTest,
