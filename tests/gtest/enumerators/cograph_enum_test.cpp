...
const char* kDir = "cograph_enum";

class CographEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CographEnumTest, CountAndAllValid) {
    ...
    CographEnumerationResult res = enumerate_cograph_graphs_cotree(n);
