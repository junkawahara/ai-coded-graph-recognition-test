...
using graph_recognition::FourLeafPowerEnumerationResult;
using graph_recognition::check_four_leaf_power;
using graph_recognition::enumerate_four_leaf_power_graphs_reverse_search;
...
const char* kDir = "four_leaf_power_enum";

class FourLeafPowerEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(FourLeafPowerEnumTest, CountAndAllValid) {
    ...
    FourLeafPowerEnumerationResult res = enumerate_four_leaf_power_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, FourLeafPowerEnumTest,
