...
const char* kDir = "convex_bipartite_enum";

class ConvexBipartiteEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ConvexBipartiteEnumTest, CountAndAllValid) {
    ...
    ConvexBipartiteEnumerationResult res = enumerate_convex_bipartite_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, ConvexBipartiteEnumTest,
