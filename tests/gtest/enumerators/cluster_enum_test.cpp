...
using graph_recognition::ClusterEnumerationResult;
using graph_recognition::check_cluster;
using graph_recognition::enumerate_cluster_graphs;
...
const char* kDir = "cluster_enum";

class ClusterEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ClusterEnumTest, CountAndAllValid) {
    ...
    ClusterEnumerationResult res = enumerate_cluster_graphs(n);
