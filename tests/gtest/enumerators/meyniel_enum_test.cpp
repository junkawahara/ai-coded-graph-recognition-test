...
using graph_recognition::MeynielEnumerationResult;
using graph_recognition::check_meyniel;
using graph_recognition::enumerate_meyniel_graphs_reverse_search;
...
const char* kDir = "meyniel_enum";

class MeynielEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(MeynielEnumTest, CountAndAllValid) {
    ...
    MeynielEnumerationResult res = enumerate_meyniel_graphs_reverse_search(n);
