...
using graph_recognition::PosetEnumerationResult;
...
const char* kDir = "poset_enum";

class PosetEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(PosetEnumTest, CountAndAllValid) {
    ...
    PosetEnumerationResult res = enumerate_posets(n);
