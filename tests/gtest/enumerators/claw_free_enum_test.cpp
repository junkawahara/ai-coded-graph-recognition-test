...
const char* kDir = "claw_free_enum";

class ClawFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ClawFreeEnumTest, CountAndAllValid) {
    ...
    ClawFreeEnumerationResult res = enumerate_claw_free_graphs_reverse_search(n);
