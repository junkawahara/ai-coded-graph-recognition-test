...
using graph_recognition::ATFreeEnumerationResult;
using graph_recognition::check_at_free;
using graph_recognition::enumerate_at_free_graphs_reverse_search;
...
const char* kDir = "at_free_enum";

class ATFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ATFreeEnumTest, CountAndAllValid) {
    ...
    ATFreeEnumerationResult res = enumerate_at_free_graphs_reverse_search(n);
