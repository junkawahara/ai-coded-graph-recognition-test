...
using graph_recognition::CochainEnumerationResult;
using graph_recognition::check_cochain;
using graph_recognition::enumerate_cochain_graphs;
...
const char* kDir = "cochain_enum";

class CochainEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CochainEnumTest, CountAndAllValid) {
    ...
    CochainEnumerationResult res = enumerate_cochain_graphs(n);
