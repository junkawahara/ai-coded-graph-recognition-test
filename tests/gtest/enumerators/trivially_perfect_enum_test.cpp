...
const char* kDir = "trivially_perfect_enum";

class TriviallyPerfectEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(TriviallyPerfectEnumTest, CountAndAllValid) {
    ...
    TriviallyPerfectEnumerationResult res = enumerate_trivially_perfect_graphs_uvd(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, TriviallyPerfectEnumTest,
