...
using graph_recognition::GemFreeEnumerationResult;
using graph_recognition::check_gem_free;
using graph_recognition::enumerate_gem_free_graphs_reverse_search;
...
const char* kDir = "gem_free_enum";

class GemFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(GemFreeEnumTest, CountAndAllValid) {
    ...
    GemFreeEnumerationResult res = enumerate_gem_free_graphs_reverse_search(n);
