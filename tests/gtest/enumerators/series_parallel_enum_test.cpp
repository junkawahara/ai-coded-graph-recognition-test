...
using graph_recognition::SeriesParallelEnumerationResult;
using graph_recognition::check_series_parallel;
using graph_recognition::enumerate_series_parallel_graphs_reverse_search;
...
const char* kDir = "series_parallel_enum";

class SeriesParallelEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(SeriesParallelEnumTest, CountAndAllValid) {
    ...
    SeriesParallelEnumerationResult res = enumerate_series_parallel_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, SeriesParallelEnumTest,
