...
using graph_recognition::CoChordalEnumerationResult;
using graph_recognition::check_co_chordal;
using graph_recognition::enumerate_co_chordal_graphs_reverse_search;
...
const char* kDir = "co_chordal_enum";

class CoChordalEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CoChordalEnumTest, CountAndAllValid) {
    ...
    CoChordalEnumerationResult res = enumerate_co_chordal_graphs_reverse_search(n);
