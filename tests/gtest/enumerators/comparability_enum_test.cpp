...
using graph_recognition::ComparabilityEnumerationResult;
using graph_recognition::check_comparability;
using graph_recognition::enumerate_comparability_graphs_reverse_search;
...
const char* kDir = "comparability_enum";

class ComparabilityEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ComparabilityEnumTest, CountAndAllValid) {
    ...
    ComparabilityEnumerationResult res = enumerate_comparability_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, ComparabilityEnumTest,
