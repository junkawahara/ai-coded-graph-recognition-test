...
const char* kDir = "block_enum";

class BlockEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(BlockEnumTest, CountAndAllValid) {
    ...
    BlockEnumerationResult res = enumerate_block_graphs_reverse_search(n);
