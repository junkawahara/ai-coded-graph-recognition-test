...
using graph_recognition::MaximalPlanarLabeledEnumerationResult;
...
const char* kDir = "maximal_planar_labeled_enum";

class MaximalPlanarLabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(MaximalPlanarLabeledEnumTest, CountAndAllValid) {
    ...
    MaximalPlanarLabeledEnumerationResult res = enumerate_maximal_planar_labeled_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, MaximalPlanarLabeledEnumTest,
