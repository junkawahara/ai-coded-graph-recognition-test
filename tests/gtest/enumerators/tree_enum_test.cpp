...
using graph_recognition::TreeEnumerationResult;
using graph_recognition::check_tree;
using graph_recognition::enumerate_tree_graphs;
...
const char* kDir = "tree_enum";

class TreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(TreeEnumTest, CountAndAllValid) {
    ...
    TreeEnumerationResult res = enumerate_tree_graphs(n);
