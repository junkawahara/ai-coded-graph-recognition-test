...
using graph_recognition::ProperCircularArcEnumerationResult;
using graph_recognition::check_proper_circular_arc;
using graph_recognition::enumerate_proper_circular_arc_graphs_reverse_search;
...
const char* kDir = "proper_circular_arc_enum";

class ProperCircularArcEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ProperCircularArcEnumTest, CountAndAllValid) {
    ...
    ProperCircularArcEnumerationResult res = enumerate_proper_circular_arc_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, ProperCircularArcEnumTest,
