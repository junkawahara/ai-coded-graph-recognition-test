...
using graph_recognition::CographLabeledEnumerationResult;
...
const char* kDir = "cograph_labeled_enum";

class CographLabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CographLabeledEnumTest, CountAndAllValid) {
    ...
    CographLabeledEnumerationResult res = enumerate_cograph_labeled_graphs_cotree(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, CographLabeledEnumTest,
