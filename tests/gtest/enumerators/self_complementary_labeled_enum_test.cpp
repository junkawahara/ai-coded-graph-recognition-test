...
using graph_recognition::SelfComplementaryLabeledEnumerationResult;
...
const char* kDir = "self_complementary_labeled_enum";

class SelfComplementaryLabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(SelfComplementaryLabeledEnumTest, CountAndAllValid) {
    ...
    SelfComplementaryLabeledEnumerationResult res = enumerate_self_complementary_labeled_graphs(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, SelfComplementaryLabeledEnumTest,
