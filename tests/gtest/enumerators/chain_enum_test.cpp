...
using graph_recognition::ChainEnumerationResult;
using graph_recognition::check_chain;
using graph_recognition::enumerate_chain_graphs;
...
const char* kDir = "chain_enum";

class ChainEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ChainEnumTest, CountAndAllValid) {
    ...
    ChainEnumerationResult res = enumerate_chain_graphs(n);
