...
using graph_recognition::CoIntervalEnumerationResult;
using graph_recognition::check_co_interval;
using graph_recognition::enumerate_co_interval_graphs_reverse_search;
...
const char* kDir = "co_interval_enum";

class CoIntervalEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CoIntervalEnumTest, CountAndAllValid) {
    ...
    CoIntervalEnumerationResult res = enumerate_co_interval_graphs_reverse_search(n);
