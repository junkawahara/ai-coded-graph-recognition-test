...
using graph_recognition::ChordalBipartiteEnumerationResult;
using graph_recognition::check_chordal_bipartite;
using graph_recognition::enumerate_chordal_bipartite_graphs_reverse_search;
...
const char* kDir = "chordal_bipartite_enum";

class ChordalBipartiteEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ChordalBipartiteEnumTest, CountAndAllValid) {
    ...
    ChordalBipartiteEnumerationResult res = enumerate_chordal_bipartite_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, ChordalBipartiteEnumTest,
