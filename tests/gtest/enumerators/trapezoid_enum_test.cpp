...
using graph_recognition::TrapezoidEnumerationResult;
using graph_recognition::check_trapezoid;
using graph_recognition::enumerate_trapezoid_graphs_reverse_search;
...
const char* kDir = "trapezoid_enum";

class TrapezoidEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(TrapezoidEnumTest, CountAndAllValid) {
    ...
    TrapezoidEnumerationResult res = enumerate_trapezoid_graphs_reverse_search(n);
