...
using graph_recognition::CaterpillarEnumerationResult;
using graph_recognition::check_caterpillar;
using graph_recognition::enumerate_caterpillar_graphs;
...
const char* kDir = "caterpillar_enum";

class CaterpillarEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CaterpillarEnumTest, CountAndAllValid) {
    ...
    CaterpillarEnumerationResult res = enumerate_caterpillar_graphs(n);
