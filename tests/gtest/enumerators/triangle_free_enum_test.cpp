...
using graph_recognition::TriangleFreeEnumerationResult;
using graph_recognition::check_triangle_free;
using graph_recognition::enumerate_triangle_free_graphs_reverse_search;
...
const char* kDir = "triangle_free_enum";

class TriangleFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(TriangleFreeEnumTest, CountAndAllValid) {
    ...
    TriangleFreeEnumerationResult res = enumerate_triangle_free_graphs_reverse_search(n);
