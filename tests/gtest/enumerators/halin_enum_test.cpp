...
using graph_recognition::HalinEnumerationResult;
using graph_recognition::check_halin;
using graph_recognition::enumerate_halin_graphs;
...
const char* kDir = "halin_enum";

class HalinEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(HalinEnumTest, CountAndAllValid) {
    ...
    HalinEnumerationResult res = enumerate_halin_graphs(n);
