...
using graph_recognition::P5FreeEnumerationResult;
using graph_recognition::check_p5_free;
using graph_recognition::enumerate_p5_free_graphs_reverse_search;
...
const char* kDir = "p5_free_enum";

class P5FreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(P5FreeEnumTest, CountAndAllValid) {
    ...
    P5FreeEnumerationResult res = enumerate_p5_free_graphs_reverse_search(n);
