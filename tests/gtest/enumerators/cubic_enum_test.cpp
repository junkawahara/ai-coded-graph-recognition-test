...
using graph_recognition::CubicEnumerationResult;
using graph_recognition::check_cubic;
using graph_recognition::enumerate_cubic_graphs;
...
const char* kDir = "cubic_enum";

class CubicEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CubicEnumTest, CountAndAllValid) {
    ...
    CubicEnumerationResult res = enumerate_cubic_graphs(n);
