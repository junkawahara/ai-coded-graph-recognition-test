...
const char* kDir = "line_graph_enum";

class LineGraphEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(LineGraphEnumTest, CountAndAllValid) {
    ...
    LineGraphEnumerationResult res = enumerate_line_graphs_reverse_search(n);
