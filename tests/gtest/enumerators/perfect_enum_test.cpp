...
using graph_recognition::PerfectEnumerationResult;
using graph_recognition::check_perfect;
using graph_recognition::enumerate_perfect_graphs_reverse_search;
...
const char* kDir = "perfect_enum";

class PerfectEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(PerfectEnumTest, CountAndAllValid) {
    ...
    PerfectEnumerationResult res = enumerate_perfect_graphs_reverse_search(n);
