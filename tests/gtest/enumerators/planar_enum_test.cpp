...
const char* kDir = "planar_enum";

class PlanarEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(PlanarEnumTest, CountAndAllValid) {
    ...
    PlanarEnumerationResult res = enumerate_planar_graphs_reverse_search(n);
