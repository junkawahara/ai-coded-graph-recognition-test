...
using graph_recognition::EvenHoleFreeEnumerationResult;
using graph_recognition::check_even_hole_free;
using graph_recognition::enumerate_even_hole_free_graphs_reverse_search;
...
const char* kDir = "even_hole_free_enum";

class EvenHoleFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(EvenHoleFreeEnumTest, CountAndAllValid) {
    ...
    EvenHoleFreeEnumerationResult res = enumerate_even_hole_free_graphs_reverse_search(n);
