...
using graph_recognition::ParityEnumerationResult;
using graph_recognition::check_parity;
using graph_recognition::enumerate_parity_graphs_reverse_search;
...
const char* kDir = "parity_enum";

class ParityEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ParityEnumTest, CountAndAllValid) {
    ...
    ParityEnumerationResult res = enumerate_parity_graphs_reverse_search(n);
