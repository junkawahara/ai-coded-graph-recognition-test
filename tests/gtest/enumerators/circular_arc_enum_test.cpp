...
using graph_recognition::CircularArcEnumerationResult;
using graph_recognition::check_circular_arc;
using graph_recognition::enumerate_circular_arc_graphs_reverse_search;
...
const char* kDir = "circular_arc_enum";

class CircularArcEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CircularArcEnumTest, CountAndAllValid) {
    ...
    CircularArcEnumerationResult res = enumerate_circular_arc_graphs_reverse_search(n);
