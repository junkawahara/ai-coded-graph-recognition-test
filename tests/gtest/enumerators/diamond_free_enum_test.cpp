...
using graph_recognition::DiamondFreeEnumerationResult;
using graph_recognition::check_diamond_free;
using graph_recognition::enumerate_diamond_free_graphs_reverse_search;
...
const char* kDir = "diamond_free_enum";

class DiamondFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(DiamondFreeEnumTest, CountAndAllValid) {
    ...
    DiamondFreeEnumerationResult res = enumerate_diamond_free_graphs_reverse_search(n);
