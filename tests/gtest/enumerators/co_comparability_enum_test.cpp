...
const char* kDir = "co_comparability_enum";

class CoComparabilityEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CoComparabilityEnumTest, CountAndAllValid) {
    ...
    CoComparabilityEnumerationResult res = enumerate_co_comparability_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, CoComparabilityEnumTest,
