...
const char* kDir = "chordal_enum";

class ChordalEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ChordalEnumTest, CountAndAllValid) {
