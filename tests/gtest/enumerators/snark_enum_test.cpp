...
using graph_recognition::SnarkEnumerationResult;
using graph_recognition::check_snark;
using graph_recognition::enumerate_snark_graphs;
...
const char* kDir = "snark_enum";

class SnarkEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(SnarkEnumTest, CountAndAllValid) {
    ...
    SnarkEnumerationResult res = enumerate_snark_graphs(n);
