...
using graph_recognition::CubicPlanarEnumerationResult;
using graph_recognition::check_cubic_planar;
using graph_recognition::enumerate_cubic_planar_graphs;
...
const char* kDir = "cubic_planar_enum";

class CubicPlanarEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CubicPlanarEnumTest, CountAndAllValid) {
    ...
    CubicPlanarEnumerationResult res = enumerate_cubic_planar_graphs(n);
