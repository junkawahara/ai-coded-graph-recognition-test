...
using graph_recognition::ThresholdEnumerationResult;
using graph_recognition::check_threshold;
using graph_recognition::enumerate_threshold_graphs;
...
const char* kDir = "threshold_enum";

class ThresholdEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ThresholdEnumTest, CountAndAllValid) {
    ...
    ThresholdEnumerationResult res = enumerate_threshold_graphs(n);
