...
const char* kDir = "permutation_enum";

class PermutationEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(PermutationEnumTest, CountAndAllValid) {
    ...
    PermutationEnumerationResult res = enumerate_permutation_graphs_reverse_search(n);
