...
const char* kDir = "cactus_enum";

class CactusEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CactusEnumTest, CountAndAllValid) {
    ...
    CactusEnumerationResult res = enumerate_cactus_graphs_reverse_search(n);
