...
using graph_recognition::FullereneEnumerationResult;
using graph_recognition::check_fullerene;
using graph_recognition::enumerate_fullerene_graphs;
...
const char* kDir = "fullerene_enum";

class FullereneEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(FullereneEnumTest, CountAndAllValid) {
    ...
    FullereneEnumerationResult res = enumerate_fullerene_graphs(n);
