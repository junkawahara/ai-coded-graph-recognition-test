...
using graph_recognition::UnicyclicEnumerationResult;
using graph_recognition::check_unicyclic;
using graph_recognition::enumerate_unicyclic_graphs;
...
const char* kDir = "unicyclic_enum";

class UnicyclicEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(UnicyclicEnumTest, CountAndAllValid) {
    ...
    UnicyclicEnumerationResult res = enumerate_unicyclic_graphs(n);
