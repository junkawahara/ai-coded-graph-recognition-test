...
using graph_recognition::BiconnectedLabeledEnumerationResult;
...
const char* kDir = "biconnected_labeled_enum";

class BiconnectedLabeledEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(BiconnectedLabeledEnumTest, CountAndAllValid) {
    ...
    BiconnectedLabeledEnumerationResult res = enumerate_biconnected_labeled_graphs(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, BiconnectedLabeledEnumTest,
