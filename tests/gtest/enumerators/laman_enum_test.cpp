...
using graph_recognition::LamanEnumerationResult;
using graph_recognition::check_laman;
using graph_recognition::enumerate_laman_graphs;
...
const char* kDir = "laman_enum";

class LamanEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(LamanEnumTest, CountAndAllValid) {
    ...
    LamanEnumerationResult res = enumerate_laman_graphs(n);
