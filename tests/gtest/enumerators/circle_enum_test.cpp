...
using graph_recognition::CircleEnumerationResult;
using graph_recognition::check_circle;
using graph_recognition::enumerate_circle_graphs_reverse_search;
...
const char* kDir = "circle_enum";

class CircleEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(CircleEnumTest, CountAndAllValid) {
    ...
    CircleEnumerationResult res = enumerate_circle_graphs_reverse_search(n);
