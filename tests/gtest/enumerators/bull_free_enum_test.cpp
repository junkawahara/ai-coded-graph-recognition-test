...
using graph_recognition::BullFreeEnumerationResult;
using graph_recognition::check_bull_free;
using graph_recognition::enumerate_bull_free_graphs_reverse_search;
...
const char* kDir = "bull_free_enum";

class BullFreeEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(BullFreeEnumTest, CountAndAllValid) {
    ...
    BullFreeEnumerationResult res = enumerate_bull_free_graphs_reverse_search(n);
