...
using graph_recognition::ApexEnumerationResult;
using graph_recognition::check_apex;
using graph_recognition::enumerate_apex_graphs_reverse_search;
...
const char* kDir = "apex_enum";

class ApexEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(ApexEnumTest, CountAndAllValid) {
    ...
    ApexEnumerationResult res = enumerate_apex_graphs_reverse_search(n);
