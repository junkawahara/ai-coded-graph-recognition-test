...
using graph_recognition::BipartiteEnumerationResult;
using graph_recognition::check_bipartite;
using graph_recognition::enumerate_bipartite_graphs_reverse_search;
...
const char* kDir = "bipartite_enum";

class BipartiteEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(BipartiteEnumTest, CountAndAllValid) {
    ...
    BipartiteEnumerationResult res = enumerate_bipartite_graphs_reverse_search(n);
