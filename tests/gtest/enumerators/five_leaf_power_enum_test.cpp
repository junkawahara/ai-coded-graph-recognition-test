...
using graph_recognition::FiveLeafPowerEnumerationResult;
using graph_recognition::check_five_leaf_power;
using graph_recognition::enumerate_five_leaf_power_graphs_reverse_search;
...
const char* kDir = "five_leaf_power_enum";

class FiveLeafPowerEnumTest : public ::testing::TestWithParam<std::string> {};

TEST_P(FiveLeafPowerEnumTest, CountAndAllValid) {
    ...
    FiveLeafPowerEnumerationResult res = enumerate_five_leaf_power_graphs_reverse_search(n);
...
INSTANTIATE_TEST_SUITE_P(
    AllCases, FiveLeafPowerEnumTest,
