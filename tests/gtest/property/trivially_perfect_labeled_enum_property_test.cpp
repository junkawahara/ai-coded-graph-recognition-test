...
TEST(TriviallyPerfectLabeledEnumProperty, EnumerationAgreesWithBruteForce) {
    int max_n = 5;

    for (int n = 1; n <= max_n; ++n) {
        auto enum_res = graph_recognition::enumerate_trivially_perfect_labeled_graphs_uvd(n);
